...
contract MoonwellWETHStrategyTest is BaseStrategyTest {
    ...
    function createStrategy(address vault, IMYTStrategy.StrategyParams memory params) internal override returns (address) {
        return address(new MoonwellStrategy(vault, params, WETH, MOONWELL_WETH_MTOKEN, COMPTROLLER, WELL, true));
    }
    ...
    function test_moonwell_weth_full_lifecycle_with_time() public {
        ...
        assertGe(finalVaultWETHBalance, vaultWETHBalance, "Vault WETH should not decrease after deallocation");
